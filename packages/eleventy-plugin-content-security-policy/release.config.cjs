...
const message =
  'chore(eleventy-plugin-content-security-policy): release v.${nextRelease.version} [skip ci]\n\n${nextRelease.notes}'
////////////////////////////////////////////////////////////////////////////////
...
// console.log('=== semantic-release (eleventy-plugin-content-security-policy) ===', config)
