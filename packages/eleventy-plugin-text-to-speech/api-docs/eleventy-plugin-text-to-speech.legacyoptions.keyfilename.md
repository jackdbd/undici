...
[Home](./index.md) &gt; [@jackdbd/eleventy-plugin-text-to-speech](./eleventy-plugin-text-to-speech.md) &gt; [LegacyOptions](./eleventy-plugin-text-to-speech.legacyoptions.md) &gt; [keyFilename](./eleventy-plugin-text-to-speech.legacyoptions.keyfilename.md)

## LegacyOptions.keyFilename property
