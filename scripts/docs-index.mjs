...
const FOOTER = [
  ...
  `This file was generated by running \`${SCRIPT_NAME}\``,
  `See ${link('scripts', 'https://github.com/jackdbd/undici/tree/main/scripts/README.md')}.`
].join('\n')
...
main({
  excluded: ['demo-site', 'test-eleventy-utils', 'text-to-audio-asset'],
